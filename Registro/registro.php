        ...
        <div class="contenedor_registro">
            <div class="registro">
                ...
                <form class="form_registro validar_form" method="post">
                    ...
                    <div class="contenedor_btnRegistro  validate-input" data-validate="Contraseña es requerida">
                        <input class="input_registro" id="contraseña" type="password" name="contraseña" placeholder="Contraseña">
                        <span class="focus-inputRegistro"></span>
                        <span class="icono-input">
